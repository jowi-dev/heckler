...
defmodule Heckler.Adapters.Twilio.Api.IncomingPhoneNumberMobile do
  @moduledoc """
  API calls for all endpoints tagged `IncomingPhoneNumberMobile`.
  """
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:FriendlyName` (String.t): A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, the is a formatted version of the phone number.
    - `:SmsApplicationSid` (String.t): The SID of the application that should handle SMS messages sent to the new phone number. If an `sms_application_sid` is present, we ignore all of the `sms_*_url` urls and use those of the application.
    ...
    - `:EmergencyStatus` (Heckler.Adapters.Twilio.Model.IncomingPhoneNumberMobileEnumEmergencyStatus.t): 
    ...
    - `:VoiceReceiveMode` (Heckler.Adapters.Twilio.Model.IncomingPhoneNumberMobileEnumVoiceReceiveMode.t): 
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.AccountIncomingPhoneNumberIncomingPhoneNumberMobile.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec create_incoming_phone_number_mobile(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.AccountIncomingPhoneNumberIncomingPhoneNumberMobile.t()} | {:error, Tesla.Env.t()}
  def create_incoming_phone_number_mobile(connection, account_sid, phone_number, opts \\ []) do
    optional_params = %{
      :ApiVersion => :form,
      :FriendlyName => :form,
    ...
    request =
      %{}
      |> method(:post)
      |> url("/2010-04-01/Accounts/#{account_sid}/IncomingPhoneNumbers/Mobile.json")
    ...
    |> evaluate_response([
      {201, Heckler.Adapters.Twilio.Model.AccountIncomingPhoneNumberIncomingPhoneNumberMobile}
    ])
  end
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.ListIncomingPhoneNumberMobileResponse.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec list_incoming_phone_number_mobile(Tesla.Env.client, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.ListIncomingPhoneNumberMobileResponse.t()} | {:error, Tesla.Env.t()}
  def list_incoming_phone_number_mobile(connection, account_sid, opts \\ []) do
    optional_params = %{
      :Beta => :query,
      :FriendlyName => :query,
      :PhoneNumber => :query,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListIncomingPhoneNumberMobileResponse}
    ])
  end
end
