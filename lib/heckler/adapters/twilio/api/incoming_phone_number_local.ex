...
defmodule Heckler.Adapters.Twilio.Api.IncomingPhoneNumberLocal do
  @moduledoc """
  API calls for all endpoints tagged `IncomingPhoneNumberLocal`.
  """
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:EmergencyStatus` (Heckler.Adapters.Twilio.Model.IncomingPhoneNumberLocalEnumEmergencyStatus.t): 
    ...
    - `:VoiceReceiveMode` (Heckler.Adapters.Twilio.Model.IncomingPhoneNumberLocalEnumVoiceReceiveMode.t): 
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.AccountIncomingPhoneNumberIncomingPhoneNumberLocal.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec create_incoming_phone_number_local(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.AccountIncomingPhoneNumberIncomingPhoneNumberLocal.t()} | {:error, Tesla.Env.t()}
  def create_incoming_phone_number_local(connection, account_sid, phone_number, opts \\ []) do
    optional_params = %{
      :ApiVersion => :form,
      :FriendlyName => :form,
    ...
    request =
      %{}
      |> method(:post)
      |> url("/2010-04-01/Accounts/#{account_sid}/IncomingPhoneNumbers/Local.json")
    ...
    |> evaluate_response([
      {201, Heckler.Adapters.Twilio.Model.AccountIncomingPhoneNumberIncomingPhoneNumberLocal}
    ])
  end
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.ListIncomingPhoneNumberLocalResponse.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec list_incoming_phone_number_local(Tesla.Env.client, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.ListIncomingPhoneNumberLocalResponse.t()} | {:error, Tesla.Env.t()}
  def list_incoming_phone_number_local(connection, account_sid, opts \\ []) do
    optional_params = %{
      :Beta => :query,
      :FriendlyName => :query,
      :PhoneNumber => :query,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListIncomingPhoneNumberLocalResponse}
    ])
  end
end
