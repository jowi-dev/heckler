...
defmodule Heckler.Adapters.Twilio.Api.ThisMonth do
  @moduledoc """
  API calls for all endpoints tagged `ThisMonth`.
  """
  ...
  - `opts` (keyword): Optional parameters
    - `:Category` (UsageRecordThisMonthEnumCategory): The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.ListUsageRecordThisMonthResponse.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec list_usage_record_this_month(Tesla.Env.client, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.ListUsageRecordThisMonthResponse.t()} | {:error, Tesla.Env.t()}
  def list_usage_record_this_month(connection, account_sid, opts \\ []) do
    optional_params = %{
      :Category => :query,
      :StartDate => :query,
      :EndDate => :query,
    ...
    request =
      %{}
      |> method(:get)
      |> url("/2010-04-01/Accounts/#{account_sid}/Usage/Records/ThisMonth.json")
    ...
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListUsageRecordThisMonthResponse}
    ])
  end
end
