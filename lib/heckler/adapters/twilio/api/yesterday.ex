...
defmodule Heckler.Adapters.Twilio.Api.Yesterday do
  @moduledoc """
  API calls for all endpoints tagged `Yesterday`.
  """
  ...
  - `opts` (keyword): Optional parameters
    - `:Category` (UsageRecordYesterdayEnumCategory): The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
  ...
  def list_usage_record_yesterday(connection, account_sid, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/2010-04-01/Accounts/#{account_sid}/Usage/Records/Yesterday.json")
    ...
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListUsageRecordYesterdayResponse}
    ])
  end
end
