...
defmodule Heckler.Adapters.Twilio.Api.LastMonth do
  @moduledoc """
  API calls for all endpoints tagged `LastMonth`.
  """
  ...
  - `opts` (keyword): Optional parameters
    - `:Category` (UsageRecordLastMonthEnumCategory): The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.ListUsageRecordLastMonthResponse.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec list_usage_record_last_month(Tesla.Env.client, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.ListUsageRecordLastMonthResponse.t()} | {:error, Tesla.Env.t()}
  def list_usage_record_last_month(connection, account_sid, opts \\ []) do
    optional_params = %{
      :Category => :query,
      :StartDate => :query,
      :EndDate => :query,
    ...
    request =
      %{}
      |> method(:get)
      |> url("/2010-04-01/Accounts/#{account_sid}/Usage/Records/LastMonth.json")
    ...
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListUsageRecordLastMonthResponse}
    ])
  end
end
