...
defmodule Heckler.Adapters.Twilio.Api.Record do
  @moduledoc """
  API calls for all endpoints tagged `Record`.
  """
  ...
  - `opts` (keyword): Optional parameters
    - `:Category` (UsageRecordEnumCategory): The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
  ...
  def list_usage_record(connection, account_sid, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/2010-04-01/Accounts/#{account_sid}/Usage/Records.json")
    ...
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListUsageRecordResponse}
    ])
  end
end
