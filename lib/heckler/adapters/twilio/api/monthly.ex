...
defmodule Heckler.Adapters.Twilio.Api.Monthly do
  @moduledoc """
  API calls for all endpoints tagged `Monthly`.
  """
  ...
  - `opts` (keyword): Optional parameters
    - `:Category` (UsageRecordMonthlyEnumCategory): The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
  ...
  - `{:ok, Heckler.Adapters.Twilio.Model.ListUsageRecordMonthlyResponse.t()}` on success
  - `{:error, Tesla.Env.t()}` on failure
  """
  @spec list_usage_record_monthly(Tesla.Env.client, String.t, keyword()) :: {:ok, Heckler.Adapters.Twilio.Model.ListUsageRecordMonthlyResponse.t()} | {:error, Tesla.Env.t()}
  def list_usage_record_monthly(connection, account_sid, opts \\ []) do
    optional_params = %{
      :Category => :query,
      :StartDate => :query,
      :EndDate => :query,
    ...
    request =
      %{}
      |> method(:get)
      |> url("/2010-04-01/Accounts/#{account_sid}/Usage/Records/Monthly.json")
    ...
    |> evaluate_response([
      {200, Heckler.Adapters.Twilio.Model.ListUsageRecordMonthlyResponse}
    ])
  end
end
