...
defmodule Heckler.Adapters.Twilio.Connection do
  @moduledoc """
  Handle Tesla connections for Heckler.Adapters.Twilio.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, Heckler.Adapters.Twilio.Connection,
  ...
  - `options`: a keyword list of Heckler.Adapters.Twilio.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:twilio_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - Heckler.Adapters.Twilio 1.0.0 - elixir"
        )
      )
