...
defmodule Heckler.Adapters.Twilio.Model.AccountAuthorizedConnectApp do
  ...
  @type t :: %__MODULE__{
    ...
    :permissions => [Heckler.Adapters.Twilio.Model.AuthorizedConnectAppEnumPermission.t] | nil,
    :uri => String.t | nil
  }
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:permissions, :list, Heckler.Adapters.Twilio.Model.AuthorizedConnectAppEnumPermission)
  end
end
