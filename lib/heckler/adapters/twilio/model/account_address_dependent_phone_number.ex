...
defmodule Heckler.Adapters.Twilio.Model.AccountAddressDependentPhoneNumber do
  ...
  @type t :: %__MODULE__{
    ...
    :address_requirements => Heckler.Adapters.Twilio.Model.DependentPhoneNumberEnumAddressRequirement.t | nil,
    ...
    :emergency_status => Heckler.Adapters.Twilio.Model.DependentPhoneNumberEnumEmergencyStatus.t | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:address_requirements, :struct, Heckler.Adapters.Twilio.Model.DependentPhoneNumberEnumAddressRequirement)
     |> Deserializer.deserialize(:emergency_status, :struct, Heckler.Adapters.Twilio.Model.DependentPhoneNumberEnumEmergencyStatus)
  end
end
