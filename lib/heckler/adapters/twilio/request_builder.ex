...
defmodule Heckler.Adapters.Twilio.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    Heckler.Adapters.Twilio.Deserializer.jason_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    Heckler.Adapters.Twilio.Deserializer.jason_decode(body, module)
  end
end
